...
public class ItemController {
	...
	public ModelAndView shopItemsList() throws ImsException {
		...
		//itemsListPage is viewname
		//items is model name , which is coming from itemService
	...
	public ModelAndView doSaveItem(@ModelAttribute("item") @Valid Item item,BindingResult result) throws ImsException {
		//@Valid says that item has to be validated.once validated it will show result in BindingResult
		//result has defined method hasErrors()
		ModelAndView mv=null;
